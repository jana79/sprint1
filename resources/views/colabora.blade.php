...
<div class="container mt-5 mb-5 shadow col-md-6 pl-5 pr-5 pb-5">					
    ...
    <div class="col-6 d-flex justify-content-between">
        <div class="col-12">
            <i class="fas fa-user"></i> Usuario registrado
            <ul>
                <li>Añadir comentarios</li>
                <li>Añadir fotografías</li>
                <li>Inscribirse en actividades</li>
            </ul>
            <a href="http://localhost:8000/colabora/registrado" class="btn btn-primary justify-content-center">Registrado</a>
        </div>
        <div class="col-12">
            <i class="fas fa-user"></i> Usuario colaborador
            <ul>
                <li>Añadir actividades</li>
                <li>Añadir comentarios</li>
                <li>Añadir fotografías</li>
            </ul>
            <a href="http://localhost:8000/colabora/colaborador" class="btn btn-primary">Colaborador</a>
        </div>        
    </div>
