...
<div class="container mt-5 mb-5 shadow col-md-6 pl-5 pr-5 pb-5">					
    ...
    somentario sobre el Museo del vino D.O Campo de Borja?</h2>
    <div class="col-6 d-flex justify-content-between">
        <div class="col-12">
            
            <a href="http://localhost:8000/eliminarComentarioOK" 
               class="btn btn-verde ml-5">Eliminar</a>
        </div>
        <div class="col-12">
            
                <a href="http://localhost:8000/poblaciones/borja/museoVino/conComentario" 
