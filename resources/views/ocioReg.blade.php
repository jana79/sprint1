...
<div class="row container mx-auto pt-3">
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/registrado/poblaciones/calatayud/zombi" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/registrado/poblaciones/borja/museoVino" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/registrado/poblaciones/daroca/musicaAntigua" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
