...
<div class="row container mx-auto pt-3">
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/colaborador/poblaciones/uncastillo/bañales" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/colaborador/poblaciones/borjaUsuario/colegiata" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center">
            <a href="http://localhost:8000/colaborador/poblaciones/mequinenza/castillo" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
