...
<div class="container mt-5 mb-5 shadow col-md-6 pl-5 pr-5">					
    ...
    <div>
        <form id="formularioLogin" method="get" class="form-horizontal pb-5" action="http://localhost:8000/registrado/inicio">
            <div class="form-group row">
                <label class="col-sm-4 col-form-label" for="usuario">Usuario *</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="usuario" name="usuario" 
                           placeholder="lucas22" aria-describedby="userHelpBlock">
