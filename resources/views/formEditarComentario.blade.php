...
<div class="container mt-5 mb-5 shadow col-md-6 pl-5 pr-5">					
    ...
    <div>
        <form id="formularioActividad" method="get" class="pb-5" action="http://localhost:8000/colaborador/editarComentarioOK">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" 
                          id="comentario" 
                          name="comentario">Hicimos la visita en pareja en septiembre de 2018. La verdad es que el museo está muy bien cuidado. 
