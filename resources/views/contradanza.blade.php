        ...
        <article>
            <header>
                <div class="item-img-wrap mb-4">
                    <img src="{{asset('images/contradanza.jpg')}}" alt="Contradanza" class="img-responsive portGral">
                </div>
            </header>
            <div>
                <p class="pt-3">La Contradanza de Cetina es una expresión 
                    espectacular única, que se representa en Cetina la noche del
                    19 de Mayo en honor de San Juan Lorenzo. El personaje llamado 
                    “el diablo” es el que dirige el baile con sus palmadas y 
                    órdenes para dar comienzo a las mudanzas (cuadros plásticos) 
                    que se van desgranando por parte de los otros ocho 
                    “contradanceros” (cuatro visten de negro con adornos blancos 
                    y cuatro de blanco con adornos negros), que cubiertos sus 
                    rostros con una “careta” van plasmando las figuras. El diablo 
                    siempre corona las figuras, ya sean de tipo laico (Los arcos, 
                    los estribos, los banquillos, la fuente, el surtidor…), 
                    mitológico (el dios de las aguas), y sobretodo religioso 
                    (San Juan Lorenzo, la Virgen de Atocha, San Pascual, 
                    la Purísima, el Calvario, la Resurrección…). Como nota 
                    curiosa, en la única que aparece el Demonio propiamente 
                    dicha es la mudanza de San Miguel, y en ella, el diablo 
                    precisamente hace de San Miguel para dar muerte al Lucifer 
                    que es interpretado por otro contradancero. El diablo, 
                    por tanto, lejos de ser un ser diabólico es un ser inquieto, 
