        ...
        <article>
            <header>
                <div class="item-img-wrap mb-4">
                    <img src="{{asset('images/ecceHomo.jpeg')}}" alt="EcceHomo" class="img-responsive portGral">
                </div>
            </header>
            <div>
                <p class="pt-3">En agosto de 2012, una vecina de Borja, Cecilia Giménez, 
                    ...
                    de Misericordia. La noticia del fallido intento de 
                    restauración no tardó en expandirse por las redes sociales 
                    y los medios de comunicación de todo el globo se hicieron 
                    eco del acontecimiento. El Ecce Homo de Borja se convirtió 
                    en poco tiempo en un fenómeno viral en Internet, los chistes 
                    y fotomontajes se propagaron como la espuma, llegando 
                    incluso a los programas de late night de la televisión 
                    americana. La repercusión mediática del fenómeno ha 
                    convertido el Ecce Homo en uno de los principales reclamos 
                    turísticos de Borja, por lo que se ha optado por dejar 
                    intacta la fallida restauración. Desde marzo de 2016, el 
                    Santuario de la Misercordia alberga un centro de 
                    interpretación dedicado al Eccehomo. En él se puede 
