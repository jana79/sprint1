...
<div class="row container mx-auto pt-3">
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/colaborador/poblaciones/daroca/gallocanta" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center pb-3">
            <a href="http://localhost:8000/colaborador/poblaciones/nuevalos/monPiedra" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="d-flex justify-content-center">
            <a href="http://localhost:8000/colaborador/poblaciones/agramonte/rutaAG2" 
               class="btn btn-verde">
                Ver actividad
            </a>
        </div>
