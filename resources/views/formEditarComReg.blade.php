...
<div class="container mt-5 mb-5 shadow col-md-6 pl-5 pr-5">					
    ...
    <div>
        <form id="formularioActividad" method="get" class="pb-5" action="http://localhost:8000/registrado/editarComentarioOK">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" 
                          id="comentario" 
                          name="comentario">Fuimos el pasado mes de septiembre. Mi familia vive en Borja y siempre he disfrutado mucho del Santuario de la Misericordia. Y ahora el Santuario tiene un nuevo inquilino.
            ...
            <div class="form-group row">
                <div class="col-sm-9 offset-sm-4 pt-5">
                    <button type="submit" class="btn btn-verde" name="submit" 
                            value="Enviar" id= "enviar">Editar</button>
                </div>
            </div>
        </form>
    </div>
