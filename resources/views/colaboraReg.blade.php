...
<div class="container mt-5 mb-5 shadow col-md-8 pl-5 pr-5 pb-5">					
    ...
    <div class="col-6 d-flex justify-content-between">
        <div class="col-12">
            ...
            <a href="http://localhost:8000/registrado/colabora/registrado" class="btn btn-verde align-self-center">Registrado</a>
        </div>
        <div class="col-12">
            ...
            <ul>
                ...
                <a href="http://localhost:8000/registrado/colabora/colaborador" class="btn btn-verde">Colaborador</a>
            </div>
        </div>        
    </div>
